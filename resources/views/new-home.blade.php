                                        ...
                                        <table>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><img src="{{ asset('backend')}}/vendor/flag-icons/24/IT.png" class="sa-language-icon d-block" alt="" title="Italy" /></td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img src="{{ asset('backend')}}/vendor/flag-icons/24/DE.png" class="sa-language-icon d-block" alt="" title="Germany" /></td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <a href="app-customer.html" class="sa-symbol sa-symbol--shape--circle sa-symbol--size--md me-3">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img src="{{ asset('backend')}}/vendor/flag-icons/24/US.png" class="sa-language-icon d-block" alt="" title="USA" /></td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <a href="app-customer.html" class="sa-symbol sa-symbol--shape--circle sa-symbol--size--md me-3">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img src="{{ asset('backend')}}/vendor/flag-icons/24/CO.png" class="sa-language-icon d-block" alt="" title="Columbia" /></td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <a href="app-customer.html" class="sa-symbol sa-symbol--shape--circle sa-symbol--size--md me-3">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img src="{{ asset('backend')}}/vendor/flag-icons/24/RS.png" class="sa-language-icon d-block" alt="" title="Srbija" /></td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <a href="app-customer.html" class="sa-symbol sa-symbol--shape--circle sa-symbol--size--md me-3">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img src="{{ asset('backend')}}/vendor/flag-icons/24/FR.png" class="sa-language-icon d-block" alt="" title="France" /></td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <a href="app-customer.html" class="sa-symbol sa-symbol--shape--circle sa-symbol--size--md me-3">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img src="{{ asset('backend')}}/vendor/flag-icons/24/RU.png" class="sa-language-icon d-block" alt="" title="Russia" /></td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <a href="app-customer.html" class="sa-symbol sa-symbol--shape--circle sa-symbol--size--md me-3">
                                    ...
                                    <ul class="list-group list-group-flush">
                                            ...
                                            <div class="d-flex align-items-center py-3">
                                                <a href="app-product.html" class="me-4">
                                                    <div class="sa-symbol sa-symbol--shape--rounded sa-symbol--size--lg">
                                                        <img src="{{ asset('backend')}}/images/products/product-1-40x40.jpg" width="40" height="40" alt="" />
                                                    </div>
                                                </a>
                                        ...
                                        <li class="list-group-item py-2">
                                            <div class="d-flex align-items-center py-3">
                                                <a href="app-product.html" class="me-4">
                                                    <div class="sa-symbol sa-symbol--shape--rounded sa-symbol--size--lg">
                                                        <img src="{{ asset('backend')}}/images/products/product-7-40x40.jpg" width="40" height="40" alt="" />
                                                    </div>
                                                </a>
                                                <div class="d-flex align-items-center flex-grow-1 flex-wrap">
                                                    <div class="col">
                                        ...
                                        <li class="list-group-item py-2">
                                            <div class="d-flex align-items-center py-3">
                                                <a href="app-product.html" class="me-4">
                                                    <div class="sa-symbol sa-symbol--shape--rounded sa-symbol--size--lg">
                                                        <img src="{{ asset('backend')}}/images/products/product-10-40x40.jpg" width="40" height="40" alt="" />
                                                    </div>
                                                </a>
                                                <div class="d-flex align-items-center flex-grow-1 flex-wrap">
                                                    <div class="col">
                                        ...
                                        <li class="list-group-item py-2">
                                            <div class="d-flex align-items-center py-3">
                                                <a href="app-product.html" class="me-4">
                                                    <div class="sa-symbol sa-symbol--shape--rounded sa-symbol--size--lg">
                                                        <img src="{{ asset('backend')}}/images/products/product-5-40x40.jpg" width="40" height="40" alt="" />
                                                    </div>
                                                </a>
                                                <div class="d-flex align-items-center flex-grow-1 flex-wrap">
                                                    <div class="col">
                                        ...
                                        <li class="list-group-item py-2">
                                            <div class="d-flex align-items-center py-3">
                                                <a href="app-product.html" class="me-4">
                                                    <div class="sa-symbol sa-symbol--shape--rounded sa-symbol--size--lg">
                                                        <img src="{{ asset('backend')}}/images/products/product-2-40x40.jpg" width="40" height="40" alt="" />
                                                    </div>
                                                </a>
                                                <div class="d-flex align-items-center flex-grow-1 flex-wrap">
                                                    <div class="col">
                                        ...
                                        <li class="list-group-item py-2">
                                            <div class="d-flex align-items-center py-3">
                                                <a href="app-product.html" class="me-4">
                                                    <div class="sa-symbol sa-symbol--shape--rounded sa-symbol--size--lg">
                                                        <img src="{{ asset('backend')}}/images/products/product-16-40x40.jpg" width="40" height="40" alt="" />
                                                    </div>
                                                </a>
                                                <div class="d-flex align-items-center flex-grow-1 flex-wrap">
                                                    <div class="col">
